...
export const routeMetadata = {
  home: corePage({
    ...
    crawlSections: [
      ...
      { title: 'Business Email & Domain Solutions', text: 'Secure custom domain business emails (@yourdomain.com) with anti-spam security, mobile sync, and Google Workspace / Microsoft 365 configuration.' },
    ],
  }),
  company: corePage({
    path: '/company',
