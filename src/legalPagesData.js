...
export const legalPages = {
  'legal:terms': {
    ...
    sections: [
      ...
      ['Third-party services', ['Domains are subject to the rules of the relevant registry and ICANN or NIXI policies. Software licences (such as cPanel, Plesk, Windows Server or Microsoft 365) are subject to their vendors’ terms.']],
      ...
      ['Governing law', ['These terms are governed by the laws of India. Courts in Hyderabad, Telangana have exclusive jurisdiction.']],
  ...
  'legal:privacy': {
    ...
    description: 'How Zexton collects, uses, stores, shares and protects personal information, and your rights under Indian data protection law.',
    intro: `This Privacy Policy explains how ${COMPANY} handles personal data when you visit zexton.com, contact us, or use our services. We process personal data in line with the Digital Personal Data Protection Act, 2023 and other applicable law.`,
    sections: [
      ['Information we collect', ['Contact and account details: name, email, phone, company, billing address and GSTIN.', 'Order and payment information. Card and UPI details are processed by our payment gateway; we do not store full card numbers.', 'Technical data: IP address, browser, device and usage logs needed to secure and operate our services.', 'Messages and files you send to our support or sales teams.']],
      ...
      ['Security', ['We use encryption in transit, access controls, monitoring and regular backups. No system is completely secure, and we will notify you and the relevant authority of a personal data breach as required by law.']],
      ['Your rights', ['You may request access to, correction of, or erasure of your personal data, and withdraw consent where processing relies on consent.', 'Contact our Grievance Officer at info@zexton.com. We respond within 30 days.']],
  ...
  'legal:aup': {
    ...
    sections: [
      ['Prohibited content', ['Content that is illegal under Indian law or the law where it is accessed.', 'Child sexual abuse material — reported immediately to authorities.', 'Material that infringes copyright, trademarks or other intellectual property.', 'Phishing pages, malware, or content designed to deceive or defraud.']],
  ...
  'legal:sla': {
    ...
    sections: [
      ['Uptime commitment', ['We target 99.9% monthly availability of the network and hosting servers, excluding scheduled maintenance.', 'Scheduled maintenance is announced at least 48 hours in advance where possible and performed during low-traffic hours (IST).']],
